        ...
        <Splide options={splideOptions}>
          {news.map((val, i) => (
            <SplideSlide key={i} className="mb-0.5 ">
              <div className="relative grid items-center gap-4 pb-2 rounded-lg ring-1 ring-slate-200">
                ...
                <div className="grid items-center justify-items-start px-4">
                  ...
                  <div className="flex items-center justify-center px-4 w-full">
                    <a
                      ...
                      rel="noreferrer"
                      role="button"
                      className="w-full bg-gradient-to-b from-slate-900 to-black shadow-md shadow-black text-center text-slate-100 py-1.5 mt-1 button-theme"
                    >
                      {val.btn}
                    </a>
                  </div>
